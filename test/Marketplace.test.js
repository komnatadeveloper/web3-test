...
contract('Marketplace', ([deployer, seller, buyer]) => {
  ...
  describe('products', async () => {
    ...
    it('creates products', async () => {
      ...
      // FAILURE: Products must have a name
      await marketplace.createProduct('', web3.utils.toWei('1', 'Ether'), {
        from: seller
      }).should.be.rejected;
      // FAILURE: Products must have a price
    ...
    it('sells products', async () => {
      ...
      // FAILURE: Tries to buy a product that does not exist i.e, the product must have a valid id
